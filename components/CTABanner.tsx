...
const CTABanner = () => {
  return (
    <section className="py-12 md:py-16 px-6 bg-white relative overflow-hidden border-t border-gray-100">

      {/* Outer Card Wrapper */}
      <div className="max-w-7xl mx-auto bg-[#15803d] rounded-lg p-8 md:p-12  text-white flex flex-col lg:flex-row items-center justify-between gap-12 overflow-hidden relative shadow-2xl shadow-green-900/15">
        ...
        <div className="flex-1 space-y-6 lg:max-w-xl relative z-10">
          ...
          <motion.p
            className="text-sm md:text-base text-green-50/90 leading-relaxed font-medium"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* Image Card - Right */}
        <motion.div
          className="flex-grow w-full lg:max-w-[45%] h-64 md:h-80 lg:h-[340px] relative rounded-lg overflow-hidden border border-white/10 shadow-xl bg-green-800"
        ...
        >
          <Image
            ...
            priority
          />
          {/* Subtle green overlay to mesh with styling */}
