    ...
    <IndustryPageTemplate
      ...
      heroTitle={
        <>
          ...
          <span className="text-[#001c55]">Partner for Financial Institutions</span>
        </>
      }
      heroDesc="Every secured lending portfolio depends on accurate warehouse verification. Hubcheck works with financial institutions to independently assess warehouses, validate collateral details, and strengthen lending oversight through thorough warehouse audits and clear reporting."
      heroImg="/images/industries/financial_institutions_hero.png"
      heroImgAlt="Hubcheck Warehouse Audit for Financial Institutions"
      statsYear="2015"
      ...
      aboutBadge="Trusted Warehouse Audit Partner for Financial Institutions"
      aboutTitle="About Hubcheck"
      aboutTexts={[
        "Hubcheck is an ISO 27001-certified, ISO 9001-certified, and SOC 2 Audited company that serves as a trusted Warehouse Audit partner for financial institutions. We help strengthen warehouse verification, collateral monitoring, and information validation through independent audit services.",
        ...
        "We integrate physical verification, documentation review, operational assessment, and structured reporting. This approach helps financial institutions build consistent warehouse review frameworks that support secured lending, warehouse financing, and internal risk assessment processes."
      ]}
      solutionsBadge="Secure Lending Support"
      solutionsTitle="Warehouse Audit Solutions for Financial Institutions"
      solutions={solutionsList}
      challengesBadge="Risk Mitigation"
      challengesTitle="Lending Challenges We Help Financial Institutions Address"
      challenges={challengesList}
      whyChooseUsBadge="Why Hubcheck"
      whyChooseUsTitle="Why Financial Institutions Choose Hubcheck"
      whyChooseUs={whyChooseUsList}
      commoditiesBadge="Comprehensive Scope"
      commoditiesTitle="Commodities We Audit for Financial Institutions"
      commoditiesDesc="Hubcheck conducts Warehouse Audit Services across a wide range of commodity storage facilities. We support financial institutions with independent verification and collateral monitoring."
